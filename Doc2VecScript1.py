...
questions = [] 
types = []
with io.open(question_dir, errors='ignore', 
...
nlp = spacy.load('en') 
processed_questions = [] 
for question in nlp.pipe(questions, n_threads=4, 
batch_size=10):
...
processed_questions = [] analyzedDocument = namedtuple('AnalyzedDocument', 'words tags') 
...
# Ending time. 	end_time = time.time() 	
...
test_batch_size = 10 def print_test_accuracy(): 		
...
iterations optimize(num_iterations=99) 
# We already performed 1 iteration above. print_test_accuracy() 
